  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        name: "allPlanUpdatePage",
        component: AllPlanUpdatePage,
      },
      {
        path: "/SearchLocationUpdatePage",
        name: "searchLocationUpdatePage",
        component: SearchLocationUpdatePage,
      },
      {
        path: "/SearechProductUpdatePage",
        name: "searechProductUpdatePage",
        component: SearechProductUpdatePage,
      },
      {
        path: "/PlanUpdatePage",
        name: "planUpdatePage",
        component: PlanUpdatePage,
      },
      {
